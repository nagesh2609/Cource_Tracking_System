...
public class AdminDaoImpl implements AdminDao {
    ...
    public String createCourse(Course course) {
        String msg = "Course creation failed...";
    ...
    @Override
    public String createFaculty(Facalty faculty) {
        String msg = "faculty insertion failed...";
    ...
    public String createBatch(Batch batch) {
        String msg = "batch creation failed...";
    ...
    // Take input and do update data to database
